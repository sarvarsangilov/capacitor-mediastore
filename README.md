...
| **`webPath`**          | <code>string \| null</code>     | URL, пригодный для использования в &lt;img src&gt; / &lt;video src&gt; внутри WebView. На Android: content://... (используйте Capacitor.convertFileSrc для http/https) На iOS: capacitor://localhost/_capacitor_file_/tmp/... На Web: совпадает с uri. |
