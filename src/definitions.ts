...
// ─── New: hasMedia / resolveMediaPath / prefetch / cancellation ──────────────
...
// ─── Streaming read for picked files ─────────────────────────────────────────
...
export interface CapacitorMediastorePlugin {
   ...
   */
  addListener(
    eventName: 'mediaLibraryChanged',
    listenerFunc: (event: MediaLibraryChangeEvent) => void,
